...
<div class="header-container">
  <header class="the-header">
    ...
    <div class="logo">
      <nuxt-link to="/">LSAH</nuxt-link>
    </div>
    <div class="spacer"></div>
    <div class="navigation-items">
      <ul class="nav-list">
        <li class="nav-item"><nuxt-link to="/aboutus">About Us</nuxt-link></li>
        <li class="nav-item"><nuxt-link to="/ourservices">Our Services</nuxt-link></li>
        ...
        <li class="nav-item"><nuxt-link to="/visitstore">Visit Store</nuxt-link></li>
      </ul>
    </div>
  </header>
</div>
